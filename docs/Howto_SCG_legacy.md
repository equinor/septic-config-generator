...
It is easiest to explain how to use the tool by example. In the docs-directory you will find a 
directory called `basic example for 1.0`. This directory contains the following directories and 
files:
